---
layout: page
title: Developerské projekty v Brandýse - Staré Boleslavi
...
textbox:
  ...
  text: >
    Nemalou část Brandýsa i Boleslavi tvoří sídliště. Záměrem jejich tvůrce byla vyváženost staveb, která společně s hojnou zelení vytvoří na relativně malé ploše přijatelné bydlení pro velký počet obyvatel. Vyšší obytné bloky domů jsou tak vyvažovány nižšími objekty občanské vybavenosti.
    <br/><br/>
    ...
    <br/><br/>
    Nejsme proti rozširování města, ale za podmínek dlouhodobé udržitelnosti, tedy výstavby sídlišť, která nejsou jen králíkárnami, ale životním prostorem.
    <br/><br/>
    <a href="../aktuality/mapa-vystavby.html">Přečíst celý článek</a>
---

Vytvořili jsme mapu, kde můžete najít jednotlivé developerské projekty. Postupně budeme doplňovat stav jejich projednání.
...
var center = SMap.Coords.fromWGS84(14.657437, 50.182983);
